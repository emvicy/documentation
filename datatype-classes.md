...
- An object of this class gets being returned by `Route::getCurrent()` (see [/1.x/routing#Get-current-route](/1.x/routing#Get-current-route))
...
- An object of this class gets being returned by `Request::getCurrentRequest()` (see [/1.x/request#Get-current-Request](/1.x/request#Get-current-Request))
