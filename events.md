...
| mvc.controller.runTargetClassPreconstruct.before      |                                                                 | `\MVC\Controller::runTargetClassPreconstruct`                                                           |                                                                 |
| mvc.controller.runTargetClassPreconstruct.fail        |                                                                 | `\MVC\Controller::runTargetClassPreconstruct`                                                           | `\MVC\DataType\DTRoute $oDTRoute`                               |
...
| mvc.worker.after                                      |                                                                 | `\MVC\Worker::run`                                                                                      | `string` _Infotext_                                             |
