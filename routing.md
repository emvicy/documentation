...
This class is generated by Emvicy's DataType Generator; see [/3.4.x/generating-datatype-classes](/3.4.x/generating-datatype-classes) for more Information.
...
object(Foo\DataType\DTRoutingAdditional)#66 (10) {
  ...
  ["aStyle":protected]=>
  array(3) {
    [0]=>string(56) "/Emvicy/assets/bootstrap-4.6.2-dist/css/bootstrap.min.css"
    [1]=>string(57) "/Emvicy/assets/font-awesome-4.7.0/css/font-awesome.min.css"
    [2]=>string(27) "/Emvicy/styles/Emvicy.min.css"
  }
  ["aScript":protected]=>
  array(4) {
    [0]=>string(46) "/Emvicy/assets/jquery/3.4.1/jquery-3.4.1.min.js"
    [1]=>string(54) "/Emvicy/assets/jquery-cookie/1.4.1/jquery.cookie.min.js"
    [2]=>string(54) "/Emvicy/assets/bootstrap-4.6.2-dist/js/bootstrap.min.js"
    [3]=>string(35) "/Emvicy/scripts/cookieConsent.min.js"
  }
}
~~~