...
If you created a module using `emvicy` (see [Creating a Module](/2.x/creating-a-module)) you will already find an Activation via Event Listener in `/modules/{module}/etc/event/default.php`:

![Emvicy Minify](/doc/2.x/minify/emvicy_minify.png)
